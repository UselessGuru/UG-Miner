...
#   @{ Algorithms = @("Cuckatoo32");   Type = "AMD"; Fee = @(0.05);  MinMemGiB = 8.0;  Tuning = ""; MinerSet = 3; WarmupTimes = @(30, 0);  ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo cuckatoo32 --cuda 0 --opencl 1" } # ASIC
    @{ Algorithms = @("Equihash1254"); Type = "AMD"; Fee = @(0.02);  MinMemGiB = 1.8;  Tuning = ""; MinerSet = 0; WarmupTimes = @(45, 0);  ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo equihash125_4 --cuda 0 --opencl 1" } # lolMiner-v1.86 is fastest
...
#   @{ Algorithms = @("Cuckatoo32");                   Type = "NVIDIA"; Fee = @(0.05);       MinMemGiB = 8.0;  Tuning = " --mt 2"; MinerSet = 3; WarmupTimes = @(30, 0);  ExcludeGPUarchitectures = @();        ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo cuckatoo32 --cuda 1 --opencl 0" } # ASIC
    ...
    @{ Algorithms = @("EtcHash");                      Type = "NVIDIA"; Fee = @(0.01);       MinMemGiB = 1.24; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = @("Other"); ExcludePools = @(@(), @("NiceHash"));   AutoCoinPers = "";             Arguments = " --algo etchash --cuda 1 --opencl 0" } # PhoenixMiner-v6.2c may be faster, but I see lower speed at the pool
    @{ Algorithms = @("EtcHash", "IronFish");          Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Tuning = " --mt 2"; MinerSet = 1; WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = @("Other"); ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo etchash --dalgo ironfish --cuda 1 --opencl 0" }
#   @{ Algorithms = @("EtcHash", "HeavyHashKaspa");    Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 15); ExcludeGPUarchitectures = @("Other"); ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo etchash --dalgo kheavyhash --cuda 1 --opencl 0" } # ASIC
    @{ Algorithms = @("EtcHash", "SHA512256d");        Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Tuning = " --mt 2"; MinerSet = 1; WarmupTimes = @(45, 90); ExcludeGPUarchitectures = @("Other"); ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo etchash --dalgo radiant --cuda 1 --opencl 0" }
    @{ Algorithms = @("Ethash");                       Type = "NVIDIA"; Fee = @(0.01);       MinMemGiB = 1.24; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = @("Other"); ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo ethash --cuda 1 --opencl 0" } # PhoenixMiner-v6.2c may be faster, but I see lower speed at the pool
    @{ Algorithms = @("Ethash", "IronFish");           Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 20); ExcludeGPUarchitectures = @("Other"); ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo ethash --dalgo ironfish --cuda 1 --opencl 0" }
#   @{ Algorithms = @("Ethash", "HeavyHashKaspa");     Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 15); ExcludeGPUarchitectures = @("Other"); ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo ethash --dalgo kheavyhash --cuda 1 --opencl 0" } # ASIC
    @{ Algorithms = @("Ethash", "SHA512256d");         Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Tuning = " --mt 2"; MinerSet = 1; WarmupTimes = @(45, 90); ExcludeGPUarchitectures = @("Other"); ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo ethash --dalgo radiant --cuda 1 --opencl 0" }
    ...
    @{ Algorithms = @("IronFish");                     Type = "NVIDIA"; Fee = @(0.01);       MinMemGiB = 2.0;  Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = @();        ExcludePools = @(@("NiceHash"), @());   AutoCoinPers = "";             Arguments = " --algo ironfish --cuda 1 --opencl 0" } # XmRig-v6.21.3.15 is almost as fast but has no fee
    @{ Algorithms = @("KawPow");                       Type = "NVIDIA"; Fee = @(0.01);       MinMemGiB = 1.24; Tuning = " --mt 2"; MinerSet = 1; WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = @("Other"); ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo kawpow --cuda 1 --opencl 0" }
    @{ Algorithms = @("HeavyHashKarlsen");             Type = "NVIDIA"; Fee = @(0.01);       MinMemGiB = 2.0;  Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = @("Other"); ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo karlsen --cuda 1 --opencl 0" }
...
#   @{ Algorithms = @("Octopus", "HeavyHashKaspa");    Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 20); ExcludeGPUarchitectures = @("Other"); ExcludePools = @(@(), @());             AutoCoinPers = "";             Arguments = " --algo octopus --dalgo kheavyhash --cuda 1 --opencl 0" } # ASIC
