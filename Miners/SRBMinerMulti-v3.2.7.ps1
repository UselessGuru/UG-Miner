...
# Added algorithm 'sha256mem' (Fairchain coin) for CPU and NVIDIA GPU mining, fee 2.50%*
# Removed algorithm 'dutahashv4'
...
$URI = "https://github.com/doktor83/SRBMiner-Multi/releases/download/3.2.7/SRBMiner-Multi-3-2-7-win64.zip"
