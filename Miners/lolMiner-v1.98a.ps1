...
$Algorithms = @(
    ...
    @{ Algorithms = @("Cuckoo29", "");                   Type = "AMD"; Fee = @(0.02);        MinMemGiB = 8.0;  MinerSet = 0; WarmupTimes = @(45, 70);  ExcludeGPUarchitectures = " ";        ExcludePools = @(@("NiceHash"), @()); Arguments = " --algo C29AE" }
...
#   @{ Algorithms = @("Cuckatoo32", "");                 Type = "AMD"; Fee = @(0.02);        MinMemGiB = 4.0;  MinerSet = 3; WarmupTimes = @(60, 70);  ExcludeGPUarchitectures = " ";        ExcludePools = @(@(), @());           Arguments = " --algo C32" } # ASIC
    ...
    @{ Algorithms = @("Autolykos2", "SHA3x");                    Type = "NVIDIA"; Fee = @(0.015, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 20);  ExcludeGPUarchitectures = " ";                ExcludePools = @(@(), @());           Arguments = " --algo AUTOLYKOS2 --dualmode SHA3XDUAL --maxdualimpact *" }
    ...
    @{ Algorithms = @("Cuckoo29", "");                           Type = "NVIDIA"; Fee = @(0.02);        MinMemGiB = 8.0;  MinerSet = 2; WarmupTimes = @(45, 60);  ExcludeGPUarchitectures = " ";                ExcludePools = @(@("NiceHash"), @()); Arguments = " --algo C29AE" }
...
#   @{ Algorithms = @("Equihash1927", "");                       Type = "NVIDIA"; Fee = @(0.01);        MinMemGiB = 3.0;  MinerSet = 0; WarmupTimes = @(45, 70);  ExcludeGPUarchitectures = " ";                ExcludePools = @(@(), @());           Arguments = " --algo EQUI192_7" } # Does not work on Nvidia
    ...
    @{ Algorithms = @("EtcHash", "Blake3");                      Type = "NVIDIA"; Fee = @(0.01, 0);     MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(90, 100); ExcludeGPUarchitectures = " ";                ExcludePools = @(@(), @("NiceHash")); Arguments = " --algo ETCHASH --dualmode ALEPHDUAL --maxdualimpact *" }
    ...
    @{ Algorithms = @("EthashB3", "Blake3");                     Type = "NVIDIA"; Fee = @(0.01, 0);     MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 90);  ExcludeGPUarchitectures = " ";                ExcludePools = @(@(), @("NiceHash")); Arguments = " --algo ETHASHB3 --dualmode ALEPHDUAL --maxdualimpact *" }
    ...
    @{ Algorithms = @("FishHash", "Blake3");                     Type = "NVIDIA"; Fee = @(0.01, 0);     MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(75, 90);  ExcludeGPUarchitectures = "^Other$|^Pascal$"; ExcludePools = @(@(), @("NiceHash")); Arguments = " --algo FISHHASH --dualmode ALEPHDUAL --maxdualimpact *" }
    ...
    @{ Algorithms = @("FishHash", "SHA3x");                      Type = "NVIDIA"; Fee = @(0.01, 0.01);  MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(75, 90);  ExcludeGPUarchitectures = "^Other$|^Pascal$"; ExcludePools = @(@(), @());           Arguments = " --algo FISHHASH --dualmode SHA3XDUAL --maxdualimpact *" }
    @{ Algorithms = @("Flux", "");                               Type = "NVIDIA"; Fee = @(0.01);        MinMemGiB = 1.00; MinerSet = 2; WarmupTimes = @(45, 70);  ExcludeGPUarchitectures = " ";                ExcludePools = @(@(), @());           Arguments = " --algo FLUX" }
    ...
    @{ Algorithms = @("HeavyHashKarlsenV2", "SHA3x");            Type = "NVIDIA"; Fee = @(0.01, 0.01);  MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(30, 0);   ExcludeGPUarchitectures = "^Other$|^Pascal$"; ExcludePools = @(@(), @());           Arguments = " --algo KARLSENV2 --dualmode SHA3XDUAL --maxdualimpact *" }
    @{ Algorithms = @("HeavyHashPyrin", "");                     Type = "NVIDIA"; Fee = @(0.01);        MinMemGiB = 2.0;  MinerSet = 0; WarmupTimes = @(30, 0);   ExcludeGPUarchitectures = "^Other$|^Pascal$"; ExcludePools = @(@(), @());           Arguments = " --algo PYRIN" }
    ...
    @{ Algorithms = @("Octopus", "SHA3x");                       Type = "NVIDIA"; Fee = @(0.02, 0.01);  MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(60, 70);  ExcludeGPUarchitectures = " ";                ExcludePools = @(@("NiceHash"), @()); Arguments = " --algo OCTOPUS --mode a --dualmode SHA3XDUAL --maximaldualimpact *" }
    ...
    @{ Algorithms = @("SHA3x", "");                              Type = "NVIDIA"; Fee = @(0.01);        MinMemGiB = 1.0;  MinerSet = 2; WarmupTimes = @(60, 20);  ExcludeGPUarchitectures = " ";                ExcludePools = @(@(), @());           Arguments = " --algo SHA3X" }
