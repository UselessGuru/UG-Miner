...
# Added algorithm 'btx' (BTX coin) for AMD/NVIDIA GPUs, fee 1.0%*
# Pearlhash related fixes
...
$URI = "https://github.com/doktor83/SRBMiner-Multi/releases/download/3.4.3/SRBMiner-Multi-3-4-3-win64.zip"
...
$Algorithms = @( 
    ...
    @{ Algorithms = @("Argon2idEfer", "");              Type = "AMD"; Fee = @(0.03);           MinMemGiB = 1;    WarmupTimes = @(45, 45); ExcludeGPUarchitectures = " ";               ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-intel --disable-gpu-nvidia --algorithm argon2id_exfer") }
    ...
    @{ Algorithms = @("BTX", "");                       Type = "AMD"; Fee = @(0.01);           MinMemGiB = 1;    WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = " ";               ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-intel --disable-gpu-nvidia --algorithm btx") }
    ...
    @{ Algorithms = @("OggPoW", "");                    Type = "AMD"; Fee = @(0.0085);         MinMemGiB = 1.24; WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = " ";               ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-intel --disable-gpu-nvidia --algorithm oggpow") }
    @{ Algorithms = @("PearlHash", "");                 Type = "AMD"; Fee = @(0.02);           MinMemGiB = 1.24; WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = " ";               ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-intel --disable-gpu-nvidia --algorithm pearlhash") }
    ...
    @{ Algorithms = @("SHA256mem", "");                 Type = "AMD"; Fee = @(0.025);          MinMemGiB = 1;    WarmupTimes = @(60, 0);  ExcludeGPUarchitectures = " ";               ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-intel --disable-gpu-nvidia --algorithm sha256mem") }
    ...
    @{ Algorithms = @("XelisHashV3", "");               Type = "AMD"; Fee = @(0.015);          MinMemGiB = 1;    WarmupTimes = @(90, 20); ExcludeGPUarchitectures = " ";               ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-intel --disable-gpu-nvidia --algorithm xelishashv3") }
    @{ Algorithms = @("XHash", "QHash");                Type = "AMD"; Fee = @(0.03);           MinMemGiB = 1.24; WarmupTimes = @(60, 15); ExcludeGPUarchitectures = " ";               ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-intel --disable-gpu-nvidia --algorithm xhash") }
    @{ Algorithms = @("XHash", "");                     Type = "AMD"; Fee = @(0.03);           MinMemGiB = 1.24; WarmupTimes = @(60, 15); ExcludeGPUarchitectures = " ";               ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-intel --disable-gpu-nvidia --algorithm xhash", " --algorithm qhash") }
    ...
    @{ Algorithms = @("Argon2idExfer", "");        Type = "CPU"; Fee = @(0.03);   WarmupTimes = @(30, 15);  ExcludePools = @(@(), @()); Arguments = @(" --disable-gpu --algorithm argon2id_exfer") }
...
#   @{ Algorithms = @("RandomxArq", "");           Type = "CPU"; Fee = @(0.0085); WarmupTimes = @(60, 0);   ExcludePools = @(@(), @()); Arguments = @(" --disable-gpu --algorithm randomarq --Randomx-use-1gb-pages") } # FPGA
    ...
    @{ Algorithms = @("SHA256mem", "");            Type = "CPU"; Fee = @(0.025);  WarmupTimes = @(60, 0);   ExcludePools = @(@(), @()); Arguments = @(" --disable-gpu --algorithm sha256mem") }
    ...
    @{ Algorithms = @("XelisHashV3", "");          Type = "CPU"; Fee = @(0.015);  WarmupTimes = @(90, 20);  ExcludePools = @(@(), @()); Arguments = @(" --disable-gpu --algorithm xelishashv3") }
    ...
    @{ Algorithms = @("MeowPow", "");                   Type = "INTEL"; Fee = @(0.0085);         MinMemGiB = 1.38; WarmupTimes = @(60, 15); ExcludeGPUarchitectures = " "; ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-nvidia --algorithm meowpow") }
    @{ Algorithms = @("NeuroMorph", "");                Type = "INTEL"; Fee = @(0.0085);         MinMemGiB = 1.38; WarmupTimes = @(60, 15); ExcludeGPUarchitectures = " "; ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-nvidia --algorithm neuromorph") }
    @{ Algorithms = @("OggPoW", "");                    Type = "INTEL"; Fee = @(0.0085);         MinMemGiB = 1.24; WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = " "; ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-nvidia --algorithm oggpow") }
    ...
    @{ Algorithms = @("XelisHashV3", "");               Type = "INTEL"; Fee = @(0.015);          MinMemGiB = 1;    WarmupTimes = @(90, 20); ExcludeGPUarchitectures = " "; ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-nvidia --algorithm xelishashv3") }
...
#   @{ Algorithms = @("XHash", "QHash");                Type = "INTEL"; Fee = @(0.03);           MinMemGiB = 1.24; WarmupTimes = @(60, 30); ExcludeGPUarchitectures = " "; ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-nvidia --algorithm xhash", " --algorithm qhash") }


    @{ Algorithms = @("Argon2idExfer", "");             Type = "NVIDIA"; Fee = @(0.03);           MinMemGiB = 1.24; WarmupTimes = @(30, 20); ExcludeGPUarchitectures = " ";        ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-intel --algorithm argon2id_exfer") }
    ...
    @{ Algorithms = @("BTX", "");                       Type = "NVIDIA"; Fee = @(0.01);           MinMemGiB = 1;    WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = " ";        ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-intel --algorithm btx") }
    @{ Algorithms = @("CryptonightGpu", "");            Type = "NVIDIA"; Fee = @(0.0085);         MinMemGiB = 1;    WarmupTimes = @(60, 30); ExcludeGPUarchitectures = "^Pascal$"; ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-intel --algorithm cryptonight_gpu") }
    @{ Algorithms = @("CryptonightTurtle", "");         Type = "NVIDIA"; Fee = @(0.0085);         MinMemGiB = 1;    WarmupTimes = @(30, 30); ExcludeGPUarchitectures = " ";        ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-intel --algorithm cryptonight_turtle") } # TeamRedMiner-v0.10.21 is fastest
    ...
    @{ Algorithms = @("PearlHash", "");                 Type = "NVIDIA"; Fee = @(0.02);           MinMemGiB = 1.24; WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = " ";        ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-intel --algorithm pearlhash") }
    ...
    @{ Algorithms = @("VertHash", "");                  Type = "NVIDIA"; Fee = @(0.01);           MinMemGiB = 1;    WarmupTimes = @(30, 30); ExcludeGPUarchitectures = "^Pascal$"; ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-intel --algorithm verthash --verthash-dat-path ..\.$($Session.VertHashDatPath)") }
    ...
    @{ Algorithms = @("XelisHashV3", "");               Type = "NVIDIA"; Fee = @(0.015);          MinMemGiB = 1;    WarmupTimes = @(90, 20); ExcludeGPUarchitectures = " ";        ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-intel --algorithm xelishashv3") }
    ...
    @{ Algorithms = @("YespowerTide", "");              Type = "NVIDIA"; Fee = @(0.0085);         MinMemGiB = 4;    WarmupTimes = @(60, 40); ExcludeGPUarchitectures = " ";        ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-intel --algorithm yespowertide") }
)
