...
$URI = "https://github.com/rigelminer/rigel/releases/download/1.13.1/rigel-1.13.1-win.zip"
...
$Algorithms = @(
    ...
    [PSCustomObject]@{ Algorithms = @("EtcHash", "HeavyHashKarlsen");    Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm etchash+karlsenhash" }
    ...
    [PSCustomObject]@{ Algorithms = @("Ethash", "HeavyHashKarlsen");     Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm ethash+karlsenhash" }
    ...
    [PSCustomObject]@{ Algorithms = @("EthashB3", "HeavyHashKarlsen");   Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm ethashb3+karlsenhash" }
