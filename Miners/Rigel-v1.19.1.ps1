...
#   @{ Algorithms = @("Autolykos2", "HeavyHashKarlsenV2");       Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm autolykos2+karlsenhashv2" } # Not supported yet
#   @{ Algorithms = @("Autolykos2", "HeavyHashPyrin");           Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm autolykos2+pyrinhash" } # https://github.com/rigelminer/rigel/issues/233#issuecomment-2483511256
    @{ Algorithms = @("Autolykos2", "HeavyHashPyrinV2");         Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm autolykos2+pyrinhashv2" }
    ...
    @{ Algorithms = @("Autolykos2", "SHA512256d");               Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm autolykos2+sha512256d" }
...
#   @{ Algorithms = @("EtcHash", "HeavyHashKarlsenv2");          Fee = @(0.007, 0.01); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm etchash+karlsenhashv2" } # Not supported yet
#   @{ Algorithms = @("EtcHash", "HeavyHashPyrin");              Fee = @(0.007, 0.01); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm etchash+pyrinhash" } # https://github.com/rigelminer/rigel/issues/233#issuecomment-2483511256
#   @{ Algorithms = @("EtcHash", "HeavyHashPyrinv2");            Fee = @(0.007, 0.01); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm etchash+pyrinhashv2" } # Not supported yet
    ...
    @{ Algorithms = @("EtcHash", "SHA512256d");                  Fee = @(0.007, 0.01); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm etchash+sha512256d" }
...
#   @{ Algorithms = @("Ethash", "HeavyHashKarlsenV2");           Fee = @(0.007, 0.01); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 10); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm ethash+karlsenhashv2" } # Not supported yet
#   @{ Algorithms = @("Ethash", "HeavyHashPyrin");               Fee = @(0.007, 0.01); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 20); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm ethash+pyrinhash" } # https://github.com/rigelminer/rigel/issues/233#issuecomment-2483511256
#   @{ Algorithms = @("Ethash", "HeavyHashPyrinV2");             Fee = @(0.007, 0.01); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 20); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm ethash+pyrinhashv2" } # Not supported yet
    ...
    @{ Algorithms = @("Ethash", "SHA512256d");                   Fee = @(0.007, 0.01); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(60, 15); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm ethash+sha512256d" }
...
#   @{ Algorithms = @("EthashB3", "HeavyHashKarlsenV2");         Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm ethashb3+karlsenhashv2" } # Not supported yet
#   @{ Algorithms = @("EthashB3", "HeavyHashPyrin");             Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm ethashb3+pyrinhash" } # https://github.com/rigelminer/rigel/issues/233#issuecomment-2483511256
#   @{ Algorithms = @("EthashB3", "HeavyHashPyrinV2");           Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm ethashb3+pyrinhashv2" } # Not supported yet
    ...
    @{ Algorithms = @("EthashB3", "SHA512256d");                 Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm ethashb3+sha512256d" }
...
#   @{ Algorithms = @("EthashSHA256", "HeavyHashKarlsenV2");     Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm abelian+karlsenhashv2" } # Not supported yet
#   @{ Algorithms = @("EthashSHA256", "HeavyHashPyrin");         Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm abelian+pyrinhash" } # https://github.com/rigelminer/rigel/issues/233#issuecomment-2483511256
    @{ Algorithms = @("EthashSHA256", "HeavyHashPyrinV2");       Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm abelian+pyrinhashv2" }
    ...
    @{ Algorithms = @("EthashSHA256", "SHA512256d");             Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm abelian+sha512256d" }
...
#   @{ Algorithms = @("FishHash", "HeavyHashKarlsenV2");         Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm fishhash+karlsenhashv2" } # Not supported yet
#   @{ Algorithms = @("FishHash", "HeavyHashPyrin");             Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm fishhash+pyrinhash" } # https://github.com/rigelminer/rigel/issues/233#issuecomment-2483511256
    @{ Algorithms = @("FishHash", "HeavyHashPyrinV2");           Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 25); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm fishhash+pyrinhashv2" }
...
#   @{ Algorithms = @("HeavyHashPyrin");                         Fee = @(0.01);        MinMemGiB = 2.0;  Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm pyrinhash" } # https://github.com/rigelminer/rigel/issues/233#issuecomment-2483511256
...
#   @{ Algorithms = @("Octopus", "HeavyHashKarlsenV2");          Fee = @(0.02, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 1; WarmupTimes = @(45, 15); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm octopus+karlsenhashv2" } # Not supported yet
#   @{ Algorithms = @("Octopus", "HeavyHashPyrin");              Fee = @(0.02, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 1; WarmupTimes = @(45, 15); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @()); Arguments = " --algorithm octopus+pyrinhash" } # https://github.com/rigelminer/rigel/issues/233#issuecomment-2483511256
