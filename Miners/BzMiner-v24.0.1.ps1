...
$Algorithms = @(
    ...
    @{ Algorithms = @("DynexSolve", "");                  Type = "AMD"; Fee = @(0.02);       MinMemGiB = 2;    Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 15); ExcludeGPUarchitectures = " ";          ExcludeGPUmodel = ""; ExcludePools = @(@(), @());           Arguments = @(" -a dynex") }
    ...
    @{ Algorithms = @("FishHash", "JanusHash");           Type = "AMD"; Fee = @(0.01, 0.02); MinMemGiB = 1.24; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(60, 60); ExcludeGPUarchitectures = " ";          ExcludeGPUmodel = ""; ExcludePools = @(@("NiceHash"), @()); Arguments = @(" -a ironfish", " --a2 warthog") } # https://github.com/bzminer/bzminer/issues/260
    ...
    @{ Algorithms = @("HeavyHashKarlsenV2", "JanusHash"); Type = "AMD"; Fee = @(0.01, 0.02); MinMemGiB = 2;    Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(60, 15); ExcludeGPUarchitectures = " ";          ExcludeGPUmodel = ""; ExcludePools = @(@("NiceHash"), @()); Arguments = @(" -a karlsen", " --a2 warthog") }
...
#   @{ Algorithms = @("Blake3", "");                      Type = "INTEL"; Fee = @(0.005);      MinMemGiB = 2;    Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 0);  ExcludeGPUarchitectures = " "; ExcludeGPUmodel = ""; ExcludePools = @(@(), @());           Arguments = @(" -a alph") } # https://github.com/bzminer/bzminer/issues
    ...
    @{ Algorithms = @("FishHash", "JanusHash");           Type = "INTEL"; Fee = @(0.01, 0.02); MinMemGiB = 1.24; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(60, 60); ExcludeGPUarchitectures = " "; ExcludeGPUmodel = ""; ExcludePools = @(@("NiceHash"), @()); Arguments = @(" -a ironfish", " --a2 warthog") } # https://github.com/bzminer/bzminer/issues/260
    ...
    @{ Algorithms = @("Autolykos2", "DynexSolve");        Type = "NVIDIA"; Fee = @(0.01, 0.02); MinMemGiB = 1.24; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 60);  ExcludeGPUarchitectures = " ";        ExcludeGPUmodel = "^MX[1|2]\d+"; ExcludePools = @(@("NiceHash"), @());           Arguments = @(" -a ergo", " --a2 dynex") }
...
#   @{ Algorithms = @("HeavyHashKaspa", "");              Type = "NVIDIA"; Fee = @(0.01);       MinMemGiB = 2;    Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 15);  ExcludeGPUarchitectures = " ";        ExcludeGPUmodel = "^MX[1|2]\d+"; ExcludePools = @(@("NiceHash"), @());           Arguments = @(" -a kaspa") } # ASIC
    @{ Algorithms = @("JanusHash", "");                   Type = "NVIDIA"; Fee = @(0.02);       MinMemGiB = 2;    Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(60, 60);  ExcludeGPUarchitectures = " ";        ExcludeGPUmodel = "";            ExcludePools = @(@("NiceHash"), @());           Arguments = @(" -a warthog") }
    @{ Algorithms = @("KawPow", "");                      Type = "NVIDIA"; Fee = @(0.01);       MinMemGiB = 1.08; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 15);  ExcludeGPUarchitectures = "^Turing$"; ExcludeGPUmodel = "^MX[1|2]\d+"; ExcludePools = @(@(), @());                     Arguments = @(" -a rvn") }
