...
# slightly increased qhash speed for NVIDIA and AMD gpu's
...
$URI = "https://github.com/andru-kun/wildrig-multi/releases/download/0.47.7/wildrig-multi-windows-0.47.7.zip"
