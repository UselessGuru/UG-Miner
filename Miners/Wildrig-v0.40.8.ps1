...
#   @{ Algorithm = "Bmw512";           Type = "AMD"; Fee = @(0.0075); MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(60, 15);  ExcludeGPUarchitectures = "^GCN1$";         ExcludePools = @();           Arguments = " --algo bmw512" } # ASIC
    ...
    @{ Algorithm = "FiroPow";          Type = "AMD"; Fee = @(0.0075); MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(15, 45);  ExcludeGPUarchitectures = "^GCN1";          ExcludePools = @();           Arguments = " --algo firopow" }
...
#   @{ Algorithm = "Lyra2RE3";         Type = "AMD"; Fee = @(0.0075); MinMemGiB = 2;    MinerSet = 2; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = "^GCN1";          ExcludePools = @();           Arguments = " --algo lyra2v3" } # ASIC
    ...
    @{ Algorithm = "MeowPow";          Type = "AMD"; Fee = @(0.0075); MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(45, 15);  ExcludeGPUarchitectures = "^GCN1";          ExcludePools = @();           Arguments = " --algo meowpow" }
...
#   @{ Algorithm = "Phi5";             Type = "AMD"; Fee = @(0.0075); MinMemGiB = 2;    MinerSet = 2; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = "^GCN1$";         ExcludePools = @();           Arguments = " --algo phi5" } # Algorithm is dead
    ...
    @{ Algorithm = "ProgPowTelestai";  Type = "AMD"; Fee = @(0.0075); MinMemGiB = 0.62; MinerSet = 2; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = "^GCN1$";         ExcludePools = @();           Arguments = " --algo progpow-telestai" }
...
#   @{ Algorithm = "X16r";             Type = "AMD"; Fee = @(0.0075); MinMemGiB = 2;    MinerSet = 3; WarmupTimes = @(30, 60);  ExcludeGPUarchitectures = "^GCN1$";         ExcludePools = @();           Arguments = " --algo x16r" } # ASIC
    ...
    @{ Algorithm = "X16rv2";           Type = "AMD"; Fee = @(0.0075); MinMemGiB = 3;    MinerSet = 0; WarmupTimes = @(45, 15);  ExcludeGPUarchitectures = "^GCN1$|^RDNA1$"; ExcludePools = @();           Arguments = " --algo x16rv2" }
