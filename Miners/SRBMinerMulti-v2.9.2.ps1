...
# Note: CCLHash, YespowerDogemone, astrixhash, xehash were removed in v2.9.5; keep these algorithms in v2.9.2
# Note: progpow_veil, progpow_quai, ethashr5 were removed in v3.1.0; keep these algorithms in v2.9.2
# Note: randomsfx, cryptonight_xhv, cryptonight_upx, argon2id_chukwa, argon2id_chukwa2 were removed in 3.2.3; keep these algorithms in v2.9.2
...
# UG: Added SHA3x (removed in v3.2.5)
# UG: Added FishHash/SHA3x (removed in v3.2.5)
# UG: Added XelisV2PepePow (removed in v3.2.5)
# UG: Added RandomhScx (removed in v3.2.5)
# UG: Added RandomXeq (removed in v3.2.5)

# Algorithm names in arguments values are case sensitive!
$Algorithms = @( 
    @{ Algorithms = @("Argon2Chukwa", "");        Type = "AMD"; Fee = @(0.0085);         MinMemGiB = 1;    WarmupTimes = @(45, 45); ExcludeGPUarchitectures = " ";               ExcludePools = @(@(), @());           AArguments = @(" --disable-cpu --disable-gpu-intel --disable-gpu-nvidia --algorithm argon2id_chukwa") }
