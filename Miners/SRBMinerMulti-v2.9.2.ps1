...
# Keep v2.9.2 for dual mining; dual mining is broken in v2.9.3

# Performance/efficiency improvements for algorithm 'walahash' on AMD RDNA and NVIDIA GPU's
# Fixed a few algorithms on NVIDIA 5000 series [blackwell] - broke in version 2.9.0
# Removed algorithm 'evohash'
# Minor bug fixes
