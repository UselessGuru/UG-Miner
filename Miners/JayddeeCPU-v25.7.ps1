...
$Algorithms = @(
    @{ Algorithm = "Allium";               WarmupTimes = @(45, 40); ExcludePools = @(); Arguments = " --algo allium" }
    @{ Algorithm = "Anime";                WarmupTimes = @(45, 60); ExcludePools = @(); Arguments = " --algo anime" }
    @{ Algorithm = "Argon2d1000";          WarmupTimes = @(45, 60); ExcludePools = @(); Arguments = " --algo argon2d1000" }
    @{ Algorithm = "Argon2d1600";          WarmupTimes = @(45, 60); ExcludePools = @(); Arguments = " --algo argon2d1600" }
    @{ Algorithm = "Argon2d250";           WarmupTimes = @(45, 60); ExcludePools = @(); Arguments = " --algo argon2d250" }
    @{ Algorithm = "Argon2d500";           WarmupTimes = @(45, 60); ExcludePools = @(); Arguments = " --algo argon2d500" }
    @{ Algorithm = "Argon2d5096";          WarmupTimes = @(45, 60); ExcludePools = @(); Arguments = " --algo argon2d5096" }
#   @{ Algorithm = "Blake2b";              WarmupTimes = @(45, 30); ExcludePools = @(); Arguments = " --algo blake2b" } # FPGA
#   @{ Algorithm = "Blake2s";              WarmupTimes = @(45, 30); ExcludePools = @(); Arguments = " --algo blake2s" } # ASIC
    @{ Algorithm = "Bastiom";              WarmupTimes = @(45, 30); ExcludePools = @(); Arguments = " --algo bastion" }
    @{ Algorithm = "BMW";                  WarmupTimes = @(45, 30); ExcludePools = @(); Arguments = " --algo bmw" }
#   @{ Algorithm = "HMQ1725";              WarmupTimes = @(45, 60); ExcludePools = @(); Arguments = " --algo hmq1725" } # GPU
    @{ Algorithm = "Jha";                  WarmupTimes = @(45, 45); ExcludePools = @(); Arguments = " --algo jha" }
    @{ Algorithm = "Lyra2z330";            WarmupTimes = @(45, 45); ExcludePools = @(); Arguments = " --algo lyra2z330" }
    @{ Algorithm = "Lyra2RE3";             WarmupTimes = @(45, 45); ExcludePools = @(); Arguments = " --algo lyra2rev3" }
    @{ Algorithm = "m7m";                  WarmupTimes = @(45, 80); ExcludePools = @(); Arguments = " --algo m7m" } # NosuchCpu-v3.8.8.1 is fastest
    @{ Algorithm = "Minotaur";             WarmupTimes = @(45, 60); ExcludePools = @(); Arguments = " --algo minotaur" }
    @{ Algorithm = "Minotaurx";            WarmupTimes = @(45, 60); ExcludePools = @(); Arguments = " --algo minotaurx" }
#   @{ Algorithm = "SHA3d";                WarmupTimes = @(45, 20); ExcludePools = @(); Arguments = " --algo SHA3d" } # FPGA
#   @{ Algorithm = "ScryptN11";            WarmupTimes = @(45, 40); ExcludePools = @(); Arguments = " --algo scrypt(N,1,1)" } # GPU
#   @{ Algorithm = "ScryptN2";             WarmupTimes = @(90, 60); ExcludePools = @(); Arguments = " --algo scrypt --param-n 1048576" } # Drops back to commandline, tested @ zpool
    @{ Algorithm = "VertHash";             WarmupTimes = @(45, 50); ExcludePools = @(); Arguments = " --algo verthash --data-file ..\.$($Session.VertHashDatPath)" }
    @{ Algorithm = "Yescrypt";             WarmupTimes = @(45, 40); ExcludePools = @(); Arguments = " --algo yescrypt" }
    @{ Algorithm = "YescryptR16";          WarmupTimes = @(45, 40); ExcludePools = @(); Arguments = " --algo yescryptr16" }
    @{ Algorithm = "YescryptR32";          WarmupTimes = @(45, 40); ExcludePools = @(); Arguments = " --algo yescryptr32" }
    @{ Algorithm = "YescryptR8";           WarmupTimes = @(45, 40); ExcludePools = @(); Arguments = " --algo yescryptr8" }
    @{ Algorithm = "Yespower2b";           WarmupTimes = @(45, 40); ExcludePools = @(); Arguments = ' --algo yespower-b2b --param-n 2048 --param-r 32 --param-key "Now I am become Death, the destroyer of worlds"' } # MicroBitcoin
    @{ Algorithm = "YespowerAdvc";         WarmupTimes = @(45, 45); ExcludePools = @(); Arguments = ' --algo yespower --param-n 2048 --param-r 32 --param-key "Let the quest begin"' } # AdventureCoin
    @{ Algorithm = "YespowerARWN";         WarmupTimes = @(45, 40); ExcludePools = @(); Arguments = ' --algo yespower --param-n 2048 --param-r 32 --param-key "ARWN"' } # Arrowana
    @{ Algorithm = "YespowerIc";           WarmupTimes = @(45, 60); ExcludePools = @(); Arguments = ' --algo yespower --param-n 2048 --param-r 32 --param-key "IsotopeC"' }
    @{ Algorithm = "YespowerInterchained"; WarmupTimes = @(45, 60); ExcludePools = @(); Arguments = ' --algo yespower --param-n 1024 --param-r 8' }
