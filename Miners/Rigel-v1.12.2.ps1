...
$Algorithms = @(
    ...
    [PSCustomObject]@{ Algorithms = @("Autolykos2", "KarlsenHash"); Fee = @(0.01, 0.01);   MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm autolykos2+karlsenhash" }
    ...
    [PSCustomObject]@{ Algorithms = @("EtcHash");                   Fee = @(0.007);        MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(55, 10); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm etchash" }
    [PSCustomObject]@{ Algorithms = @("EtcHash", "Blake3");         Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm etchash+alephium" }
    [PSCustomObject]@{ Algorithms = @("EtcHash", "IronFish");       Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm etchash+ironfish" }
    [PSCustomObject]@{ Algorithms = @("EtcHash", "KarlsenHash");    Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm etchash+karlsenhash" }
    [PSCustomObject]@{ Algorithms = @("EtcHash", "SHA512256d");     Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @("ZPool")); Arguments = " --algorithm etchash+sha512256d" }
    [PSCustomObject]@{ Algorithms = @("Ethash");                    Fee = @(0.007);        MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(55, 15); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm ethash" }
    [PSCustomObject]@{ Algorithms = @("Ethash", "Blake3");          Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; Minerset = 2; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm ethash+alephium" }
    [PSCustomObject]@{ Algorithms = @("Ethash", "IronFish");        Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; Minerset = 2; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm ethash+ironfish" }
    [PSCustomObject]@{ Algorithms = @("Ethash", "KarlsenHash");     Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; Minerset = 2; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm ethash+karlsenhash" }
    [PSCustomObject]@{ Algorithms = @("Ethash", "SHA512256d");      Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; Minerset = 2; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @("ZPool")); Arguments = " --algorithm ethash+sha512256d" }
    [PSCustomObject]@{ Algorithms = @("EthashB3");                  Fee = @(0.01);         MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(55, 15); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm ethashb3" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "Blake3");        Fee = @(0.01, 0.007);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(55, 10); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm ethashb3+alephium" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "IronFish");      Fee = @(0.01, 0.007);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(55, 10); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm ethashb3+ironfish" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "KarlsenHash");   Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; Minerset = 2; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm ethashb3+karlsenhash" }
    ...
    [PSCustomObject]@{ Algorithms = @("Octopus", "KarlsenHash");    Fee = @(0.02, 0.007);  MinMemGiB = 0.94; Tuning = " --mt 2"; Minerset = 1; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm octopus+karlsenhash" }
