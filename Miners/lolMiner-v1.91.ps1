...
$URI = "https://github.com/Lolliedieb/lolMiner-releases/releases/download/1.91/lolMiner_v1.91_Win64.zip"
...
$Algorithms = @(
    ...
    @{ Algorithms = @("Autolykos2", "HeavyHashKarlsenV2");       Type = "AMD"; Fee = @(0.015, 0.01); MinMemGiB = 1.24; MinerSet = 1; WarmupTimes = @(45, 20);  ExcludeGPUarchitectures = " ";                ExcludePools = @(@(), @());           Arguments = " --algo AUTOLYKOS2 --dualmode PYRINV2DUAL" }
...
#   @{ Algorithms = @("EtcHash", "HeavyH00ashKarlsen");            Type = "AMD"; Fee = @(0.01, 0.01);  MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(60, 90);  ExcludeGPUarchitectures = " ";                ExcludePools = @(@(), @());           Arguments = " --algo ETCHASH --dualmode KARLSENDUAL" } # No hashrate for second algorithm
...
#   @{ Algorithms = @("UbqHash", "SHA512256d");                  Type = "AMD"; Fee = @(0.01, 0.01);  MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(60, 90);  ExcludeGPUarchitectures = "^GCN\d+$";         ExcludePools = @(@(), @());           Arguments = " --algo UBQHASH --dualmode RXDDUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1986
    ...
    @{ Algorithms = @("Autolykos2", "HeavyHashKarlsenV2");       Type = "NVIDIA"; Fee = @(0.015, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 20);  ExcludeGPUarchitectures = " ";                ExcludePools = @(@(), @());           Arguments = " --algo AUTOLYKOS2 --dualmode PYRINV2DUAL --maxdualimpact *" }
