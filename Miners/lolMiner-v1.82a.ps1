...
#   [PSCustomObject]@{ Algorithms = @("EtcHash", "KarlsenHash");     Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(60, 90); ExcludeGPUArchitecture = " ";         ExcludePools = @(@(), @()); Arguments = " --algo ETCHASH --dualmode KARLSENDUAL" } # No hashrate for second algorithm
#   [PSCustomObject]@{ Algorithms = @("EtcHash", "kHeavyHash");      Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(90, 90); ExcludeGPUArchitecture = "^RDNA1$";   ExcludePools = @(@(), @()); Arguments = " --algo ETCHASH --dualmode KASPADUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1987 & https://github.com/Lolliedieb/lolMiner-releases/issues/1991
...
#   [PSCustomObject]@{ Algorithms = @("Ethash", "KarlsenHash");      Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(60, 90); ExcludeGPUArchitecture = " ";         ExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode KARLSENDUAL" } # No hashrate for second algorithm
#   [PSCustomObject]@{ Algorithms = @("Ethash", "kHeavyHash");       Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(90, 90); ExcludeGPUArchitecture = "^RDNA1$";   ExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode KASPADUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1987 & https://github.com/Lolliedieb/lolMiner-releases/issues/1991
#   [PSCustomObject]@{ Algorithms = @("Ethash", "SHA512256d");       Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = "^GCN4$";    ExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode RXDDUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1986
    ...
    [PSCustomObject]@{ Algorithms = @("EthashB3", "KarlsenHash");    Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(60, 90); ExcludeGPUArchitecture = "^GCN4$";    ExcludePools = @(@(), @()); Arguments = " --algo ETHASHB3 --dualmode KARLSENDUAL" }
...
#   [PSCustomObject]@{ Algorithms = @("UbqHash", "kHeavyHash");      Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(90, 90); ExcludeGPUArchitecture = "^RDNA1$";   ExcludePools = @(@(), @()); Arguments = " --algo UBQHASH --dualmode KASPADUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1987 & https://github.com/Lolliedieb/lolMiner-releases/issues/1991
...
#   [PSCustomObject]@{ Algorithms = @("EtcHash", "kHeavyHash");      Type = "INTEL"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = " "; ExcludePools = @(@(), @()); Arguments = " --algo ETCHASH --dualmode KASPADUAL --maxdualimpact *" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1991
...
#   [PSCustomObject]@{ Algorithms = @("EtcHash", "KarlsenHash");     Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 1; WarmupTimes = @(60, 90); ExcludeGPUArchitecture = " "; ExcludePools = @(@(), @()); Arguments = " --algo ETCHASH --dualmode KARLSENDUAL --maxdualimpact *" } # No hashrate for second algorithm
#   [PSCustomObject]@{ Algorithms = @("EtcHash", "kHeavyHash");      Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 1; WarmupTimes = @(90, 90); ExcludeGPUArchitecture = " "; ExcludePools = @(@(), @()); Arguments = " --algo ETCHASH --dualmode KASPADUAL --maxdualimpact *" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1991
...
#   [PSCustomObject]@{ Algorithms = @("Ethash", "KarlsenHash");      Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(60, 90); ExcludeGPUArchitecture = " "; ExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode KARLSENDUAL --maxdualimpact *" } # No hashrate for second algorithm
#   [PSCustomObject]@{ Algorithms = @("Ethash", "kHeavyHash");       Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(90, 90); ExcludeGPUArchitecture = " "; ExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode KASPADUAL --maxdualimpact *" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1991
...
#   [PSCustomObject]@{ Algorithms = @("UbqHash", "kHeavyHash");      Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(90, 90); ExcludeGPUArchitecture = " "; ExcludePools = @(@(), @()); Arguments = " --algo UBQHASH --dualmode KASPADUAL --maxdualimpact *" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1991
