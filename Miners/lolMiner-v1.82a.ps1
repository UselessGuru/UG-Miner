...
#   [PSCustomObject]@{ Algorithms = @("EtcHash", "HeavyHashKaspa");    Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(90, 90); ExcludeGPUArchitecture = "^RDNA1$";   ExcludePools = @(@(), @()); Arguments = " --algo ETCHASH --dualmode KASPADUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1987 & https://github.com/Lolliedieb/lolMiner-releases/issues/1991
...
#   [PSCustomObject]@{ Algorithms = @("Ethash", "HeavyHashKaspa");     Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(90, 90); ExcludeGPUArchitecture = "^RDNA1$";   ExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode KASPADUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1987 & https://github.com/Lolliedieb/lolMiner-releases/issues/1991
...
#   [PSCustomObject]@{ Algorithms = @("EtcHash", "HeavyHashKaspa"); Type = "INTEL"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = " "; ExcludePools = @(@(), @()); Arguments = " --algo ETCHASH --dualmode KASPADUAL --maxdualimpact *" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1991
#   [PSCustomObject]@{ Algorithms = @("HeavyHashKaspa");            Type = "INTEL"; Fee = @(0.0075);     MinMemGiB = 2.0;  MinerSet = 2; WarmupTimes = @(60, 50); ExcludeGPUArchitecture = " "; ExcludePools = @(@(), @()); Arguments = " --algo KASPA" } #  https://github.com/Lolliedieb/lolMiner-releases/issues/1991
...
#   [PSCustomObject]@{ Algorithms = @("Ethash", "HeavyHashKaspa");     Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(90, 90); ExcludeGPUArchitecture = " "; ExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode KASPADUAL --maxdualimpact *" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1991
