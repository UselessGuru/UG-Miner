...
#   @{ Algorithms = @("RandomxArq", "");           Type = "CPU"; Fee = @(0.0085); MinerSet = 2; WarmupTimes = @(60, 0);   ExcludePools = @(@(), @());           Arguments = @(" --disable-gpu --algorithm randomarq --Randomx-use-1gb-pages") } # FPGA
    ...
    @{ Algorithms = @("RandomhScx", "");           Type = "CPU"; Fee = @(0.02);   MinerSet = 2; WarmupTimes = @(90, 20);  ExcludePools = @(@(), @());           Arguments = @(" --disable-gpu --algorithm randomhscx --Randomx-use-1gb-pages") }
    ...
    @{ Algorithms = @("YespowerEQPAY", "");        Type = "CPU"; Fee = @(0.002);  MinerSet = 2; WarmupTimes = @(60, 40);  ExcludePools = @(@(), @());           Arguments = @(" --disable-gpu --algorithm yespowereqpay") }
    @{ Algorithms = @("YespowerInterchained", ""); Type = "CPU"; Fee = @(0.0085); MinerSet = 2; WarmupTimes = @(60, 25);  ExcludePools = @(@(), @());           Arguments = @(" --disable-gpu --algorithm yespowerinterchained") }
    ...
    @{ Algorithms = @("MeowPow", "");                   Type = "INTEL"; Fee = @(0.0085);         MinMemGiB = 1.24; MinerSet = 1; WarmupTimes = @(60, 15); ExcludeGPUarchitectures = " "; ExcludePools = @(@(), @());           Arguments = @(" --disable-cpu --disable-gpu-amd --disable-gpu-nvidia --algorithm meowpow") }
