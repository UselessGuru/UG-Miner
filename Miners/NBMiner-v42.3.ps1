...
$Algorithms = @(
    ...
    @{ Algorithm = "KawPow";     Type = "AMD"; Fee = @(0.02); MinMemGiB = 1.20; AdditionalWin10MemGB = 0; MinerSet = 2; WarmupTimes = @(30, 0);  ExcludeGPUarchitectures = @(); ExcludePools = @();                         Arguments = " --algo kawpow --platform 2" } # XmRig-v6.22.0.3 is almost as fast but has no fee
    ...
    @{ Algorithm = "KawPow";     Type = "NVIDIA"; Fee = @(0.02); MinMemGiB = 1.20; AdditionalWin10MemGB = 0; MinComputeCapability = 6.0; MinerSet = 2; Tuning = " -mt 1"; WarmupTimes = @(30, 10); ExcludeGPUarchitectures = @();         ExcludePools = @();                         Arguments = " --algo kawpow --platform 1" } # XmRig-v6.22.0.3 is almost as fast but has no fee
