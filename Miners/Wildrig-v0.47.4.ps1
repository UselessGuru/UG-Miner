...
# minor improvements to qhash and fix possible rejects
...
$URI = "https://github.com/andru-kun/wildrig-multi/releases/download/0.47.4/wildrig-multi-windows-0.47.4.zip"
...
#   @{ Algorithm = "Lyra2RE2";         Type = "AMD"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 2; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo lyra2v2" } # ASIC
    ...
    @{ Algorithm = "NexaPow";          Type = "AMD"; Fee = @(0.0075); MinMemGiB = 3;    MinerSet = 2; WarmupTimes = @(45, 15);  ExcludeGPUarchitectures = "^GCN\d$"; ExcludePools = @("NiceHash"); Arguments = " --algo nexapow" } # https://github.com/andru-kun/wildrig-multi/issues/277
...
#   @{ Algorithm = "Pufferfish2BMB";   Type = "AMD"; Fee = @(0);      MinMemGiB = 8;    MinerSet = 2; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo pufferfish2" } # waiting for coin to resurrect
    @{ Algorithm = "QHash";            Type = "AMD"; Fee = @(0.02);   MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo qhash" }
...
#   @{ Algorithm = "SHA256d";          Type = "AMD"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo sha256d" } # ASIC
    ...
    @{ Algorithm = "SkyDoge";          Type = "AMD"; Fee = @(0.02);   MinMemGiB = 2;    MinerSet = 2; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo skydoge" }
...
#   @{ Algorithm = "X16r";             Type = "AMD"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 3; WarmupTimes = @(30, 60);  ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo x16r" } # ASIC
    ...
    @{ Algorithm = "X16rv2";           Type = "AMD"; Fee = @(0);      MinMemGiB = 3;    MinerSet = 0; WarmupTimes = @(150, 15); ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo x16rv2" }
...
#   @{ Algorithm = "Pufferfish2BMB";   Type = "INTEL"; Fee = @(0);      MinMemGiB = 8;    MinerSet = 2; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " "; ExcludePools = @();           Arguments = " --algo pufferfish2 --watchdog" } # waiting for coin to resurrect
    @{ Algorithm = "QHash";            Type = "INTEL"; Fee = @(0.02);   MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " "; ExcludePools = @();           Arguments = " --algo qhash" }
...
#   @{ Algorithm = "SHA256d";          Type = "INTEL"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " "; ExcludePools = @();           Arguments = " --algo sha256d" } # ASIC
    ...
    @{ Algorithm = "SkyDoge";          Type = "INTEL"; Fee = @(0.02);   MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(45, 15);  ExcludeGPUarchitectures = " "; ExcludePools = @();           Arguments = " --algo skydoge --watchdog" }
...
#   @{ Algorithm = "X16r";             Type = "INTEL"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 3; WarmupTimes = @(45, 60);  ExcludeGPUarchitectures = " "; ExcludePools = @();           Arguments = " --algo x16r --watchdog" } # ASIC
    ...
    @{ Algorithm = "X16rv2";           Type = "INTEL"; Fee = @(0);      MinMemGiB = 3;    MinerSet = 0; WarmupTimes = @(150, 15); ExcludeGPUarchitectures = " "; ExcludePools = @();           Arguments = " --algo x16rv2 --watchdog" }
...
#   @{ Algorithm = "Pufferfish2BMB";   Type = "NVIDIA"; Fee = @(0);      MinMemGiB = 8;    MinerSet = 2; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " ";                ExcludePools = @();           Arguments = " --algo pufferfish2 --watchdog" } # waiting for coin to resurrect
    @{ Algorithm = "QHash";            Type = "NVIDIA"; Fee = @(0.02);   MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " ";                ExcludePools = @();           Arguments = " --algo qhash --watchdog" }
...
#   @{ Algorithm = "SHA256d";          Type = "NVIDIA"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " ";                ExcludePools = @();           Arguments = " --algo sha256d --watchdog" } # ASIC
    ...
    @{ Algorithm = "SkyDoge";          Type = "NVIDIA"; Fee = @(0.02);   MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(45, 15);  ExcludeGPUarchitectures = " ";                ExcludePools = @();           Arguments = " --algo skydoge --watchdog" }
...
#   @{ Algorithm = "X16r";             Type = "NVIDIA"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 3; WarmupTimes = @(45, 60);  ExcludeGPUarchitectures = " ";                ExcludePools = @();           Arguments = " --algo x16r --watchdog" } # ASIC
    ...
    @{ Algorithm = "X16rv2";           Type = "NVIDIA"; Fee = @(0);      MinMemGiB = 3;    MinerSet = 0; WarmupTimes = @(150, 15); ExcludeGPUarchitectures = " ";                ExcludePools = @();           Arguments = " --algo x16rv2 --watchdog" }
...
#   @{ Algorithm = "X20r";             Type = "NVIDIA"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 2; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = "^Other$|^Pascal$"; ExcludePools = @();           Arguments = " --algo x20r --watchdog" } # ASIC
    ...
    @{ Algorithm = "X22i";             Type = "NVIDIA"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 2; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " ";                ExcludePools = @();           Arguments = " --algo x22i --watchdog" }
    @{ Algorithm = "X25x";             Type = "NVIDIA"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 2; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " ";                ExcludePools = @();           Arguments = " --algo x25x --watchdog" }
