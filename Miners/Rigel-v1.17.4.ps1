...
$Algorithms = @(
    ...
    [PSCustomObject]@{ Algorithms = @("EthashB3");                         Fee = @(0.01);        MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @(); ExcludePools = @(@("ZergPool"), @());        Arguments = " --algorithm ethashb3" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "Blake3");               Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUArchitecture = @(); ExcludePools = @(@("ZergPool"), @());        Arguments = " --algorithm ethashb3+alephium" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "HeavyHashKarlsen");     Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@("ZergPool"), @());        Arguments = " --algorithm ethashb3+karlsenhash" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "HeavyHashPyrin");       Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 2; WarmupTimes = @(45, 25); ExcludeGPUArchitecture = @(); ExcludePools = @(@("ZergPool"), @());        Arguments = " --algorithm ethashb3+pyrinhash" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "FishHash");             Fee = @(0.01, 0.01);  MinMemGiB = 6.0;  Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUArchitecture = @(); ExcludePools = @(@("ZergPool"), @());        Arguments = " --algorithm ethashb3+fishhash" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "SHA512256d");           Fee = @(0.01, 0.01);  MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUArchitecture = @(); ExcludePools = @(@("ZergPool"), @("ZPool")); Arguments = " --algorithm ethashb3+sha512256d" }
