...
#   [PSCustomObject]@{ Algorithm = "Allium";        MinerSet = 3; WarmupTimes = @(30, 0);   ExcludePools = @();           Arguments = " --algo allium" } # https://github.com/rplant8/cpuminer-opt-rplant/issues/52 / # FPGA
...
#   [PSCustomObject]@{ Algorithm = "Qubit";         MinerSet = 3; WarmupTimes = @(30, 15);  ExcludePools = @();           Arguments = " --algo qubit" } # ASIC
    ...
    [PSCustomObject]@{ Algorithm = "RWAHash";       MinerSet = 0; WarmupTimes = @(30, 15);  ExcludePools = @();           Arguments = " --algo rwahash" }
...
#   [PSCustomObject]@{ Algorithm = "Yescrypt";      MinerSet = 0; WarmupTimes = @(45, 10);  ExcludePools = @();           Arguments = " --algo yescrypt" } # https://github.com/rplant8/cpuminer-opt-rplant/issues/50
#    [PSCustomObject]@{ Algorithm = "YescryptR16";   MinerSet = 0; WarmupTimes = @(45, 0);   ExcludePools = @();           Arguments = " --algo yescryptr16" } # CcminerLyraYesscrypt-v8.21r18v5 is faster
    ...
    [PSCustomObject]@{ Algorithm = "YescryptR8g";   MinerSet = 2; WarmupTimes = @(45, 0);   ExcludePools = @("ZergPool"); Arguments = " --algo yescryptr8g" } # https://github.com/rplant8/cpuminer-opt-rplant/issues/48
...
#   [PSCustomObject]@{ Algorithm = "Yespower";      MinerSet = 0; WarmupTimes = @(45, 15);  ExcludePools = @();           Arguments = " --algo yespower" } # https://github.com/rplant8/cpuminer-opt-rplant/issues/49
