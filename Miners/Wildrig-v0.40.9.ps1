...
$URI = "https://github.com/andru-kun/wildrig-multi/releases/download/0.40.9/wildrig-multi-windows-0.40.9.zip"
...
#   @{ Algorithm = "Bmw512";           Type = "AMD"; Fee = @(0.0075); MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(60, 15);  ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo bmw512" } # ASIC
    ...
    @{ Algorithm = "KawPow";           Type = "AMD"; Fee = @(0.0075); MinMemGiB = 0.62; MinerSet = 1; WarmupTimes = @(45, 0);   ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo kawpow" } # TeamRedMiner-v0.10.21 is fastest on Navi
...
#   @{ Algorithm = "X16r";             Type = "AMD"; Fee = @(0.0075); MinMemGiB = 2;    MinerSet = 3; WarmupTimes = @(30, 60);  ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo x16r" } # ASIC
    ...
    @{ Algorithm = "X16rv2";           Type = "AMD"; Fee = @(0.0075); MinMemGiB = 3;    MinerSet = 0; WarmupTimes = @(45, 15);  ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo x16rv2 --opencl-threads 1" } # https://github.com/andru-kun/wildrig-multi/issues/303: Try ' --opencl-threads 1'
...
#   @{ Algorithm = "HeavyHash";        Type = "INTEL"; Fee = @(0.0075); MinMemGiB = 2;    MinerSet = 1; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " "; ExcludePools = @();           Arguments = " --algo heavyhash" } # FPGA, Not yet supported on Nvidia
    ...
    @{ Algorithm = "KawPow";           Type = "INTEL"; Fee = @(0.0075); MinMemGiB = 0.90; MinerSet = 1; WarmupTimes = @(45, 0);   ExcludeGPUarchitectures = " "; ExcludePools = @();           Arguments = " --algo kawpow --watchdog" }
...
#   @{ Algorithm = "Bmw512";           Type = "NVIDIA"; Fee = @(0.0075); MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(60, 15);  ExcludeGPUarchitectures = " ";        ExcludePools = @();           Arguments = " --algo bmw512 --watchdog" } # ASIC
    ...
    @{ Algorithm = "KawPow";           Type = "NVIDIA"; Fee = @(0.0075); MinMemGiB = 1.24; MinerSet = 1; WarmupTimes = @(45, 0);   ExcludeGPUarchitectures = " ";        ExcludePools = @();           Arguments = " --algo kawpow --watchdog" }
