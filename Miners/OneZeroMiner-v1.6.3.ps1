...
# Performance improvement for Qubitcoin (varies by generation)
...
$URI = "https://github.com/OneZeroMiner/onezerominer/releases/download/v1.6.3/onezerominer-win64-1.6.3.zip"
