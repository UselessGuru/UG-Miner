...
$URI = Switch ($Session.DriverVersion.CUDA) { 
    { $_ -ge [System.Version]"11.4" } { "https://github.com/UselessGuru/UG-Miner-Binaries/releases/download/CryptoDredge/CryptoDredge_0.27.0_cuda_11.4_windows.zip"; Break }
    Default                           { Return }
}
