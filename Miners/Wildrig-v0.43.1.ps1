...
# implemented evohash(0% dev-fee), use addition parameters -i 18 --gpu-threads 1 --diff-factor 256
...
$URI = "https://github.com/andru-kun/wildrig-multi/releases/download/0.43.1/wildrig-multi-windows-0.43.1.zip"
...
#   @{ Algorithm = "Bmw512";           Type = "AMD"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(60, 15);  ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo bmw512" } # ASIC
    ...
    @{ Algorithm = "EvoHash";          Type = "AMD"; Fee = @(0);      MinMemGiB = 1;    MinerSet = 0; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " ";       ExcludePools = @();           Arguments = " --algo evohash -i 18 --gpu-threads 1 --diff-factor 256" }
...
#   @{ Algorithm = "Bmw512";           Type = "INTEL"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(60, 15);  ExcludeGPUarchitectures = " "; ExcludePools = @();           Arguments = " --algo bmw512 --watchdog" } # ASIC
    ...
    @{ Algorithm = "EvoHash";          Type = "INTEL"; Fee = @(0);      MinMemGiB = 1;    MinerSet = 0; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " "; ExcludePools = @();           Arguments = " --algo evohash -i 18 --gpu-threads 1 --diff-factor 256" }
...
#   @{ Algorithm = "Bmw512";           Type = "NVIDIA"; Fee = @(0);      MinMemGiB = 2;    MinerSet = 0; WarmupTimes = @(60, 15);  ExcludeGPUarchitectures = " ";                ExcludePools = @();           Arguments = " --algo bmw512 --watchdog" } # ASIC
    ...
    @{ Algorithm = "EvoHash";          Type = "NVIDIA"; Fee = @(0);      MinMemGiB = 1;    MinerSet = 0; WarmupTimes = @(30, 15);  ExcludeGPUarchitectures = " ";                ExcludePools = @();           Arguments = " --algo evohash -i 18 --gpu-threads 1 --diff-factor 256" }
