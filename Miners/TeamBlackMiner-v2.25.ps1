...
$Algorithms = @(
    ...
    @{ Algorithms = @("EtcHash", "VertHash");    Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 1; Tuning = ""; WarmupTimes = @(120, 15); ExcludeGPUarchitectures = @();        ExcludePools = @(@(), @());                                         Arguments = " --algo etc+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" } # 120 Seconds; https://github.com/sp-hash/TeamBlackMiner/issues/450
    ...
    @{ Algorithms = @("Ethash", "EthashB3");     Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 2; Tuning = ""; WarmupTimes = @(120, 15); ExcludeGPUarchitectures = @("RDNA1"); ExcludePools = @(@(), @("ZergPool"));                               Arguments = " --algo eth+ethb3" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "EvrProgPow");   Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 2; Tuning = ""; WarmupTimes = @(90, 15);  ExcludeGPUarchitectures = @();        ExcludePools = @(@(), @("ZergPool"));                               Arguments = " --algo eth+evr" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "FiroPow");      Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 2; Tuning = ""; WarmupTimes = @(90, 15);  ExcludeGPUarchitectures = @();        ExcludePools = @(@(), @("ZergPool"));                               Arguments = " --algo eth+firo" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "KawPow");       Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 2; Tuning = ""; WarmupTimes = @(90, 45);  ExcludeGPUarchitectures = @();        ExcludePools = @(@(), @("HashCryptos", "MiningDutch", "ZergPool")); Arguments = " --algo eth+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "MeowPow");      Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 2; Tuning = ""; WarmupTimes = @(90, 45);  ExcludeGPUarchitectures = @();        ExcludePools = @(@(), @("ZergPool"));                               Arguments = " --algo eth+meow" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "VertHash");     Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 1; Tuning = ""; WarmupTimes = @(120, 15); ExcludeGPUarchitectures = @();        ExcludePools = @(@(), @("ZergPool"));                               Arguments = " --algo eth+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" } # https://github.com/sp-hash/TeamBlackMiner/issues/455 & 120 Secs; https://github.com/sp-hash/TeamBlackMiner/issues/450
    ...
    @{ Algorithms = @("EtcHash", "VertHash");    Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 2; Tuning = " --tweak 2"; WarmupTimes = @(120, 20); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @());                                         Arguments = " --algo etc+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" } #  # https://github.com/sp-hash/TeamBlackMiner/issues/455 & https://github.com/sp-hash/TeamBlackMiner/issues/450
    @{ Algorithms = @("Ethash");                 Type = "NVIDIA"; Fee = @(0.005);        MinMemGiB = 1.24; MinerSet = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 15);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @("ZergPool"));                               Arguments = " --algo ethash" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "EthashB3");     Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 1; Tuning = " --tweak 2"; WarmupTimes = @(90, 45);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @("ZergPool"));                               Arguments = " --algo eth+ethb3" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "EvrProgPow");   Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 1; Tuning = " --tweak 2"; WarmupTimes = @(90, 45);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @("HashCryptos"));                            Arguments = " --algo eth+evr" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "FiroPow");      Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 1; Tuning = " --tweak 2"; WarmupTimes = @(90, 45);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @("ZergPool"));                               Arguments = " --algo eth+firo" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "KawPow");       Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 2; Tuning = " --tweak 2"; WarmupTimes = @(90, 20);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @("HashCryptos", "MiningDutch", "ZergPool")); Arguments = " --algo eth+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "MeowPow");      Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 2; Tuning = " --tweak 2"; WarmupTimes = @(90, 20);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @("ZergPool"));                               Arguments = " --algo eth+meow" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "VertHash");     Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.70; MinerSet = 2; Tuning = " --tweak 2"; WarmupTimes = @(90, 20);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @());                                         Arguments = " --algo eth+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" } # https://github.com/sp-hash/TeamBlackMiner/issues/450
    @{ Algorithms = @("EthashB3");               Type = "NVIDIA"; Fee = @(0.005);        MinMemGiB = 1.24; MinerSet = 1; Tuning = " --tweak 2"; WarmupTimes = @(120, 15); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @());                                         Arguments = " --algo ethashb3" }
    ...
    @{ Algorithms = @("EthashB3", "VertHash");   Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.70; MinerSet = 2; Tuning = " --tweak 2"; WarmupTimes = @(120, 45); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @());                                         Arguments = " --algo ethb3+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" } # https://github.com/sp-hash/TeamBlackMiner/issues/450
    ...
    @{ Algorithms = @("VertHash");               Type = "NVIDIA"; Fee = @(0.005);        MinMemGiB = 3.0;  MinerSet = 0; Tuning = " --tweak 2"; WarmupTimes = @(30, 0);   ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @());                                         Arguments = " --algo verthash --verthash-data ..\.$($Variables.VerthashDatPath)" } # https://github.com/sp-hash/TeamBlackMiner/issues/450
)
