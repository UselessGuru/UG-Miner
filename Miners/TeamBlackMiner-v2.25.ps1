...
$Algorithms = @(
    ...
    @{ Algorithms = @("EtcHash", "VertHash");    Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 2; Tuning = " --tweak 2"; WarmupTimes = @(120, 60); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @());                             Arguments = " --algo etc+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" } #  # https://github.com/sp-hash/TeamBlackMiner/issues/455 & https://github.com/sp-hash/TeamBlackMiner/issues/450
    ...
    @{ Algorithms = @("Ethash", "VertHash");     Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.70; MinerSet = 2; Tuning = " --tweak 2"; WarmupTimes = @(90, 45);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @());                             Arguments = " --algo eth+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" } # https://github.com/sp-hash/TeamBlackMiner/issues/450
    @{ Algorithms = @("EthashB3");               Type = "NVIDIA"; Fee = @(0.005);        MinMemGiB = 1.24; MinerSet = 1; Tuning = " --tweak 2"; WarmupTimes = @(120, 60); ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @());                             Arguments = " --algo ethashb3" }
