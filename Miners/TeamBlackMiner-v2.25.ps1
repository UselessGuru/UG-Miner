...
$Algorithms = @(
    ...
    @{ Algorithms = @("Ethash", "VertHash");     Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 1; Tuning = ""; WarmupTimes = @(120, 15); ExcludeGPUarchitectures = @();        ExcludePools = @(@(), @());                             Arguments = " --algo eth+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" } # https://github.com/sp-hash/TeamBlackMiner/issues/455 & 120 Secs; https://github.com/sp-hash/TeamBlackMiner/issues/450
    ...
    @{ Algorithms = @("Ethash");                 Type = "NVIDIA"; Fee = @(0.005);        MinMemGiB = 1.24; MinerSet = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 15);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @());                             Arguments = " --algo ethash" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "EthashB3");     Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 1; Tuning = " --tweak 2"; WarmupTimes = @(90, 45);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @());                             Arguments = " --algo eth+ethb3" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    ...
    @{ Algorithms = @("Ethash", "FiroPow");      Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 1; Tuning = " --tweak 2"; WarmupTimes = @(90, 45);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @());                             Arguments = " --algo eth+firo" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "KawPow");       Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 2; Tuning = " --tweak 2"; WarmupTimes = @(90, 20);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @("HashCryptos", "MiningDutch")); Arguments = " --algo eth+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
    @{ Algorithms = @("Ethash", "MeowPow");      Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; MinerSet = 2; Tuning = " --tweak 2"; WarmupTimes = @(90, 20);  ExcludeGPUarchitectures = @(); ExcludePools = @(@(), @());                             Arguments = " --algo eth+meow" } # https://github.com/sp-hash/TeamBlackMiner/issues/455
