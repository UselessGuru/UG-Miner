...
#   [PSCustomObject]@{ Algorithms = @("Ethash", "SHA512256d");         Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 90);  ExcludeGPUArchitecture = "^GCN4$";                  ExcludePools = @(@(), @());           Arguments = " --algo ETHASH --dualmode RXDDUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1986
    [PSCustomObject]@{ Algorithms = @("EthashB3");                     Type = "AMD"; Fee = @(0.01);       MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 70);  ExcludeGPUArchitecture = "^GCN4$";                  ExcludePools = @(@("ZergPool"), @()); Arguments = " --algo ETHASHB3" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1992
    [PSCustomObject]@{ Algorithms = @("EthashB3", "Blake3");           Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 90);  ExcludeGPUArchitecture = "^GCN4$";                  ExcludePools = @(@("ZergPool"), @()); Arguments = " --algo ETHASHB3 --dualmode ALEPHDUAL" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "HeavyHashKarlsen"); Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(60, 90);  ExcludeGPUArchitecture = "^GCN4$";                  ExcludePools = @(@("ZergPool"), @()); Arguments = " --algo ETHASHB3 --dualmode KARLSENDUAL" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "HeavyHashPyrin");   Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 90);  ExcludeGPUArchitecture = "^GCN4$";                  ExcludePools = @(@("ZergPool"), @()); Arguments = " --algo ETHASHB3 --dualmode PYRINDUAL" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "SHA512256d");       Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 100); ExcludeGPUArchitecture = "^GCN4$";                  ExcludePools = @(@("ZergPool"), @()); Arguments = " --algo ETHASHB3 --dualmode RXDDUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1986
...
#   [PSCustomObject]@{ Algorithms = @("Ethash", "SHA512256d");         Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = " ";                ExcludePools = @(@(), @());           Arguments = " --algo ETHASH --dualmode RXDDUAL --maxdualimpact *" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1986
    [PSCustomObject]@{ Algorithms = @("EthashB3");                     Type = "NVIDIA"; Fee = @(0.01);       MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 70); ExcludeGPUArchitecture = " ";                ExcludePools = @(@("ZergPool"), @()); Arguments = " --algo ETHASHB3" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "Blake3");           Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = " ";                ExcludePools = @(@("ZergPool"), @()); Arguments = " --algo ETHASHB3 --dualmode ALEPHDUAL --maxdualimpact *" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "HeavyHashPyrin");   Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = " ";                ExcludePools = @(@("ZergPool"), @()); Arguments = " --algo ETHASHB3 --dualmode PYRINDUAL --maxdualimpact *" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "HeavyHashKarlsen"); Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = " ";                ExcludePools = @(@("ZergPool"), @()); Arguments = " --algo ETHASHB3 --dualmode KARLSENDUAL --maxdualimpact *" }
    [PSCustomObject]@{ Algorithms = @("EthashB3", "SHA512256d");       Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 2; WarmupTimes = @(60, 90); ExcludeGPUArchitecture = " ";                ExcludePools = @(@("ZergPool"), @()); Arguments = " --algo ETHASHB3 --dualmode RXDDUAL --maxdualimpact *" }
